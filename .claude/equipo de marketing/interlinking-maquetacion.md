...
- Plantillas de CTA de WordPress: `recursos/plantillas-cta.html`
...
4. **HTML final listo para WordPress** en `publicar/[slug].html`: artículo completo con los enlaces insertados, los bloques de CTA de las plantillas colocados, el bloque de lead magnet en su posición, meta title (≤60 caracteres) y meta description (≤155 caracteres) al principio del archivo como comentario
...
- Respetar el estilo corporativo en tablas: cabecera verde #1a5c38, filas alternas, y las plantillas CTA de `recursos/plantillas-cta.html` tal cual, cambiando solo textos y enlaces
